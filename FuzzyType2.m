...
modelfile = fullfile(pwd, '9_link_snake_19-03-2021distb(type2-robust).emx');
...
%clear;
xxsimSetLogVariables({'time','vt'});
xxsimSetLogVariables({'time','Qt'});
%xxsimSetLogVariables({'time','amplitude'});
xxsimRun(); 
